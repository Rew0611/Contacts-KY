                  ...
                  <div className="col-md-12 col-sm-12">
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        ...
                        >
                          <b className="is-hidden">Kashi Yatra </b>
                          <b className="is-hidden">Cultural Fest</b>
                          <b className="is-visible">IIT Varanasi</b>
                        </span>
                      </h1>
                      <div className="about-social-icon text-center">
                        <ul className="about-social">
                          <li className="wow fadeIn" data-wow-delay=".4s">
                            <a
                              href="https://www.linkedin.com/in/kashiyatra01"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".2s">
                            <a
                              href="https://github.com/kashiyatra"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".6s">
                            <a
                              href="https://www.instagram.com/kashiyatra01/"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay=".8s">
                            <a
                              href="https://twitter.com/kashiyatra01"
                              target="newtab"
                            >
                              <i
                          ...
                          <li className="wow fadeIn" data-wow-delay="1s">
                            <a href="https://dev.to/kashiyatra" target="newtab">
                    ...
                    <div className="service-details" data-wow-delay=".1s">
                      ...
                      <div className="service-bottom">
                        <i
                          ...
                          aria-hidden="true"
                        ></i>
                        <h3>Juliet Rylance</h3>
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>+91 5724294022 Juliet.rylance.ece21@iitbhu.ac.in</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6">
                    <div className="service-details" data-wow-delay=".1s">
                      <div className="service-head">
                        <img src="assets/img/service/b.jpg" alt="e-commarce" />
                      </div>
                      <div className="service-bottom">
                        <i
                        ...
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>+91 3738493922 James.ray.ece21@iitbhu.ac.in</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6">
                    <div className="service-details" data-wow-delay=".1s">
                      <div className="service-head">
                        <img
                          src="https://images.hdqwalls.com/wallpapers/thumb/emma-watson-monochrome-5k-om.jpg"
                          alt="analytics"
                        />
                      </div>
                      <div className="service-bottom">
                        ...
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>+91 224940024853 clare.foley.ece20@iitbhu.ac.in</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6">
                    <div className="service-details" data-wow-delay=".1s">
                      ...
                      <div className="service-bottom">
                        ...
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>+91 5839530503 david.leitch.ece21@iitbhu.ac.in</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6">
                    <div className="service-details" data-wow-delay=".1s">
                      ...
                      <div className="service-bottom">
                        <i
                          ...
                          aria-hidden="true"
                        ></i>
                        <h3>Michael Nyqvist</h3>
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>+91 849305032 michael.nyqvist.ece21@iitbhu.ac.in</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-4 col-sm-6">
                    <div className="service-details" data-wow-delay=".1s">
                      ...
                      <div className="service-bottom">
                        ...
                        <div className="underline1"></div>
                        <div className="underline2"></div>
                        <p>+91 4839403022 eva.longoria.ece21@itbhu.ac.in</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <div className="main-title text-center wow fadeIn">
                          ...
                          <div className="underline2"></div>
                          <p>
                            People attended Kashiyatra have said some nice
                            things
                          </p>
                        </div>
                      </div>
                            ...
                            >
                              ...
                              <div className="carousel-inner">
                                <div className="active item">
                                  <blockquote>
                                    <p>
                                      “It’s a great platform to excel,perform
                                      and show the skills for those who thrive
                                      for passion..”
                                      <br />
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “A very great college fest that will reach
                                      infinite height. Kudos to Team Kashiyatra
                                      for organising such a enjoying and
                                      energetic fest.”
                                      <br />
                                ...
                                <div className="item">
                                  <blockquote>
                                    <p>
                                      “kashiyatra has done a fantastic job
                                      overall. Not only the site is to design,
                                      but the code is also very clean and slick.
                                      Love the way he achieved the translations
                                      portion of the site.”
                                      <br />
                  ...
                  <div className="row">
                    <div className="col-md-12 col-sm-12">
                      <div className="main-title text-center wow fadeIn">
                        ...
                        <div className="underline2"></div>
                        <p>
                          We are always open to discus product design work or
                  ...
                  <div className="row contact-info-row text-center wow fadeIn">
                    ...
                    <div className="col-md-3 col-sm-6 contact-colamn">
                      <div className="contact-col-info" data-wow-delay=".4s">
                        ...
                        <h3>Email</h3>
                        <a
                          href="mailto:contact.kashiyatra@gmail.com"
                          style={{
                            color: "black",
                            textDecoration: "none",
                            fontSize: "17px",
